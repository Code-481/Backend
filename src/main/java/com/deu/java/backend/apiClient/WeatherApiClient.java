...
public class WeatherApiClient {
    ...
    static Dotenv dotenv = Dotenv.configure()
            ...
            .ignoreIfMissing()
            .load();
    private static final String todayWeatherKey = dotenv.get("TODAY_WEATHER_API_KEY");//7MBK14sBR8iASteLAafIPg
    private static final String weekWeatherKey = dotenv.get("WEEK_WEATHER_API_KEY");//JqqAloFPS0yqgJaBT-tM4Q
