...
public class HyominClient {
    private static final Logger log = LoggerFactory.getLogger(HyominClient.class);
    private static final String BASE_URL = "http://dorm.deu.ac.kr/hyomin/food/getWeeklyMenu.kmc?locgbn=DE&sch_date=";
    ...
    public List<Map<String, Object>> fetchWeeklyMenu(LocalDate baseDate) {
        ...
        try (Response response = client.newCall(request).execute()) {
            ...
            log.error("효민 기숙사 식단 데이터 가져오기 실패", e);
